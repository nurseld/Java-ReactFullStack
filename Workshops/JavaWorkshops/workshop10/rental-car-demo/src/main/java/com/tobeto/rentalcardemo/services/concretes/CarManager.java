...
import com.tobeto.rentalcardemo.repositories.CarRepository;
...
//        car.setBrandName(requests.getBrandName());
//        car.setModelName(requests.getModelName());
//        car.setModelYear(requests.getModelYear());
//        car.setFuelType(requests.getFuelType());
//        car.setGearType(requests.getGearType());
//        car.setDailyPrice(requests.getDailyPrice());
//
