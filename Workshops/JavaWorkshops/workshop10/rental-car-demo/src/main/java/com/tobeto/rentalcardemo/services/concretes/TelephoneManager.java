...
import com.tobeto.rentalcardemo.entities.concretes.Telephone;
import com.tobeto.rentalcardemo.repositories.CustomerRepository;
import com.tobeto.rentalcardemo.repositories.TelephoneRepository;
...
public class TelephoneManager implements TelephoneService {
   ...
   private final TelephoneRepository telephoneRepository;
    ...
    public AddTelephoneResponse add(AddTelephoneRequest request) {
        ...
        response.setId(savedTelephone.getId());
        return response;
    }
