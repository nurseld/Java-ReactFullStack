...
--   5. Ürünlerin maliyetinin 15 ile 25 arasında olduğu 
--   Ürün listesini (`ProductID`, `ProductName`, `UnitPrice`) almak için bir sorgu yazın.
...
SELECT UPPER(CONCAT('TR ',product_name)) AS product_name
FROM products;

--   16. a.Fiyatı 20 den küçük ürünlerin adının başına TR ekle.

SELECT CONCAT('TR ',product_name) AS product_name, unit_price
FROM products
WHERE unit_price < 20;

--   17. En pahalı ürün listesini (`ProductName` , `UnitPrice`) 
...
--   18. En pahalı on ürünün Ürün listesini 
